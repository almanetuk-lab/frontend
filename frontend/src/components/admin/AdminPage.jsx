...
//    // UserDetailsModal with ALL fields
//   const UserDetailsModal = () => {
//     if (!selectedUser) return null;
...
//     // Safe array checks
//     const userSkills = Array.isArray(selectedUser.skills) ? selectedUser.skills : [];
//     const userInterests = Array.isArray(selectedUser.interests) ? selectedUser.interests : [];
...
// //   // Safe array check for skills and interests
// //   const userSkills = Array.isArray(selectedUser.skills) ? selectedUser.skills : [];
// //   const userInterests = Array.isArray(selectedUser.interests) ? selectedUser.interests : [];
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Full Name</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900 font-medium">{selectedUser.full_name || selectedUser.name || 'No Name'}</p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Phone</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.phone || selectedUser.phone_number || 'Not provided'}</p>
// //               </div>
// //             </div>
...
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">
// //                   {selectedUser.dob || selectedUser.date_of_birth ? new Date(selectedUser.dob || selectedUser.date_of_birth).toLocaleDateString() : 'Not specified'}
// //                 </p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Profession</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.profession || selectedUser.occupation || 'Not specified'}</p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Education</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.education || selectedUser.qualification || 'Not specified'}</p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Company</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.company || selectedUser.workplace || 'Not specified'}</p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">City</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.city || selectedUser.location || 'Not specified'}</p>
// //               </div>
// //             </div>
...
// //               <label className="block text-sm font-medium text-gray-700 mb-2">Address</label>
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900">{selectedUser.address || selectedUser.full_address || 'Not specified'}</p>
// //               </div>
// //             </div>

// //             {/* Skills & Interests - FIXED */}
// //             <div className="md:col-span-2 lg:col-span-3 mt-6">
// //               <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">Skills & Interests</h3>
// //             </div>
...
// //               <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
// //                 <p className="text-gray-900 whitespace-pre-line">
// //                   {selectedUser.about || selectedUser.bio || selectedUser.description || 'No description provided'}
// //                 </p>
// //               </div>
// //             </div>

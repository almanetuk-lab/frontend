...
//   console.log("🏠 DashboardHome rendering with profile:", profile);

//   // ✅ SAFE PROFILE DATA
//   const safeProfile = useMemo(() => {
//     return {
//       full_name: profile?.full_name || "User",
//       profession: profile?.profession || "Add your profession",
//       city: profile?.city || "Add your city", 
//       age: profile?.age || "",
...
//   // If no profile, show simple message
...
//           Welcome, {safeProfile.full_name}!
//         </h1>
        
//         <div className="flex items-center gap-4 mb-6">
//           {safeProfile.profile_picture_url ? (
//             <img
//               src={safeProfile.profile_picture_url}
//               alt="Profile"
//               className="w-16 h-16 rounded-full"
//             />
//           ) : (
//             <div className="w-16 h-16 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold">
//               {safeProfile.full_name.charAt(0)}
//             </div>
//           )}
          
//           <div>
//             <p className="text-gray-600">{safeProfile.profession}</p>
//             <p className="text-gray-500 text-sm">
//               📍 {safeProfile.city} {safeProfile.age && `• ${safeProfile.age} years`}
//             </p>
//           </div>
//         </div>
...
//   // ✅ SAFE PROFILE DATA - Fallback values add kiye
//   const safeProfile = useMemo(() => {
//     return {
//       full_name: profile?.full_name || profile?.name || "User",
//       profession: profile?.profession || profile?.occupation || profile?.headline || "Add your profession",
//       city: profile?.city || profile?.location || "Add your city",
//       age: profile?.age || "24",
...
//                       </p>
//                       <p className="text-gray-500 text-sm sm:text-base flex items-center gap-1 truncate">
//                         📍 {safeProfile.city} • {safeProfile.age} years
//                       </p>
//                     </div>

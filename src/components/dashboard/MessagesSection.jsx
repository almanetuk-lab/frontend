...
//   // ✅ FIXED: GET REACTIONS FOR MESSAGE - PROPER FILTERING
//   const getMessageReactions = (messageId) => {
//     if (!messageId) return [];
...
//       r.message_id?.toString() === messageId?.toString()
//     );
    
//     console.log(`🎭 Reactions for message ${messageId}:`, messageReactions);
    
//     // ✅ Group similar reactions with counts
...
//           };
//         }
//         reactionGroups[emoji].count += 1;
//         reactionGroups[emoji].reactions.push(reaction);
//       }
//     });
...
//                           {/* ✅ FIXED: REACTIONS DISPLAY */}
//                           <div className="flex flex-wrap gap-1 mt-2">
//                             {getMessageReactions(message.id).map((reactionGroup, index) => (
//                               <span 
//                                 key={`${reactionGroup.emoji}-${index}`} 
//                                 className="text-xs bg-white bg-opacity-90 px-2 py-1 rounded-full border border-gray-300 flex items-center gap-1 shadow-sm"
//                                 title={`${reactionGroup.count} reaction(s)`}
//                               >
...
//     // ✅ YEH FIX KARO - Data structure check
//     let reactionsData = [];

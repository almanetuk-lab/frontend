          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <ActivityItem
                  icon="💖"
                  text={`You have ${loading ? "..." : matchesCount || 155 } new match${
                    matchesCount !== 1 ? "es" : ""
                  } waiting`}
                  time="Today"
                />
...
// // src/components/dashboard/DashboardHome.jsx
// impot, { useState, useMemo, useEffect } from "react";
// import { useNavigate } from "react-router-dom";
// import StatCard from "../comman/StatCard";
...
//     // Now messages_count will come from API
//     setMessagesCount(dashboardSummary.messages_count || 0);

//     // Only update if API returns values
//     if (dashboardSummary.matches_count !== undefined) {
//       setMatchesCount(dashboardSummary.matches_count);
//     }
//     if (dashboardSummary.connections_count !== undefined) {
...
// // Separate function for real-time updates (optional)
// const fetchUnreadMessages = async () => {
//   try {
//     const count = await profileViewApi.getUnreadMessagesCount(userId);
//     setMessagesCount(count); // Update messages count
//     console.log("📩 Unread messages count:", count);
//   } catch (error) {
//     console.error("Failed to fetch unread messages:", error);
//     setMessagesCount(0);
...
//   // Optional: Real-time updates every 30 seconds
//   const interval = setInterval(() => {
//     fetchUnreadMessages(); // Only fetch messages for real-time update
//   }, 30000);
...
//   //       setConnectionsCount(dashboardSummary.connections_count);
//   //     }
//   //     if (dashboardSummary.messages_count !== undefined) {
//   //       setMessagesCount(dashboardSummary.messages_count);
//   //     }
//   //   } catch (error) {
//   //     console.error("Error fetching dashboard data:", error);
//   //   } finally {
...
//                     } ${totalViewers === 1 ? "person" : "people"} today`}
//                     time={
//                       loading
//                         ? "Loading..."
//                         : recentViewers.length > 0
...
//                 <ActivityItem
//                   icon="💖"
//                   text={`You have ${loading ? "..." : matchesCount} new match${
//                     matchesCount !== 1 ? "es" : ""
//                   } waiting`}
//                   time="Today"
//                 />
...
//                         : firstName ||
//                           lastName ||
//                           `User #${viewer.viewer_id || viewer.id || index}`;

//                     return (
//                       <div
//                         key={viewer.id || `viewer-${index}`}
//                         onClick={() =>
//                           handleViewerClick(viewer.viewer_i || viewer.i)
//                         }

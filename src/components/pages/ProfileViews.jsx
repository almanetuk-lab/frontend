...
const ProfileViews = () => {
  ...
  // // ✅ FIXED: Handle viewer click - Navigate to profile page
  // const handleViewerClick = async (viewer) => {
  //   const viewerId = viewer.viewer_id || viewer.id || viewer.user_id;

  //   if (viewerId) {
  //     console.log("Navigating to profile page with ID:", viewerId);

  //     try {
  //       // ✅ OPTIONAL: Track that you viewed their profile
  //       // await recentApi.trackProfileView(viewerId);

  //       // ✅ Navigate to profile page with the viewer's ID
  //       navigate(`/profile/${viewerId}`, {
  //         state: {
  //           from: "profile_views",
  //           viewerData: viewer // Pass viewer data to profile page
  //         }
  //       });
  ...
  //     }
  //   } else {
  //     console.warn("Cannot navigate: No viewer ID found", viewer);
  //   }
  // };

  //   // ✅ FIXED: Handle viewer click
  // const handleViewerClick = (viewer) => {
  //   console.log("Navigating to profile page with viewer:", viewer);

  //   // ✅ IMPORTANT: Use user_id from viewer object
  //   const viewerId = viewer.user_id; // Backend से यही आ रहा है
  ...
  //       state: {
  //         from: "profile_views",
  //         viewerData: viewer // पूरा viewer object भेजें
  //       }
  //     });
  //   } else {
  //     console.warn("Cannot navigate: No user_id found", viewer);
  //   }
  // };
  // ✅ FINAL FIXED: Handle viewer click
  ...
  // const handleViewerClick = (viewer) => {
  //   console.log("🎯 View Profile clicked from Profile Views:", viewer);

  //   const viewerId = viewer.user_id; // Backend से user_id आ रहा है

  //   if (viewerId) {
  //     console.log(`Navigating to /profile/${viewerId}`);

  //     // ✅ Correct navigation with proper state
  //     navigate(`/profile/${viewerId}`, {
  //       state: {
  //         userProfile: viewer,  // ✅ यही key ProfilePage में check हो रही है
  //         from: "profile_views"
  //       }
  //     });
  //   } else {
...
//   // ProfileViews.jsx में handleViewerClick function update करें
// const handleViewerClick = async (viewer) => {
...
//       // ✅ Navigate to user profile page (जैसे browse member में)
